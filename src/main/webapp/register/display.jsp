...
"jdbc:mysql://192.168.254.189:3306/"; String dbName = "tracom"; String userId =
"tracom"; String password = "Mclass#64"; try { Class.forName(driverName); }
catch (ClassNotFoundException e) { e.printStackTrace(); } Connection connection
...
<table align="center" cellpadding="5" cellspacing="5" border="1">
	...
	register"; resultSet = statement.executeQuery(sql); while(resultSet.next()){
	%>
	<tr bgcolor="#DEB887">
